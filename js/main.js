...
(function() {
    ...
    // --- 1. Base de Datos ---
    const families = [
        { id: 1, name: "Jamones y Fiambres", icon: "img/ubicacio.png" },
        { id: 2, name: "Ahumados", icon: "img/ubicacio.png" },
        { id: 3, name: "Salchichas", icon: "img/ubicacio.png" },
        { id: 4, name: "Mortadelas", icon: "img/ubicacio.png" } 
    ];
